                                ...
                                {users.map((user) => (
                                    <tr key={user.usuario_id} className="hover:bg-gray-800">
                                        ...
                                        <td className="px-6 py-4 flex justify-center items-center">
                                            {
                                                <button type="button" className="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-2 py-1 me-1 mb-1 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">
